...
int main() {
    ...
    outFile << "R " << best_R << std::endl;
    outFile << "l " << 0.1 * (best_k_for_l + 1) << std::endl;
    outFile << "s " << 0.1 * (best_k_for_l + 1) + 1 << std::endl;
    outFile << "J " << best_J << std::endl;
    return 0;
}